<main>
    <div class="bg_color_2">
        <div class="container margin_60_35">
            <div id="login-2">
                <h1>ลงชื่อเข้าใช้งาน สำหรับคลินิก!</h1>
                ...
                <?php echo form_close(); ?>
                <p class="text-center link_bright">สำหรับคลินิกที่ต้องการสมัครใช้งานนัดหมอ <a href="<?php echo base_url('physician/register') ?>"><strong>คลินิกสมัครสมาชิกใหม่</strong></a></p>

              ...
              <div class="row">
                ...
                <div class="col-lg-7 col-md-8">
                  ...
                  <ul class="contacts">
                    ...
                    <li>
                      <h6>ติดต่อสอบถามการบริการ</h6> โทร:<a href="tel:<?php echo $clinic->PHONE; ?>"> <?php echo $clinic->PHONE; ?></a> Line: <a href="http://line.me/ti/p/<?php echo $clinic->LINE; ?>" target="_blank"> <?php echo $clinic->LINE; ?></a>
                    </li>
                  </ul>
                </div>
              </div>

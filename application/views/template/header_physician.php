    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Reviews">
                <a class="nav-link" href="<?php echo base_url('physician/ques-noti');?>">
                    <i class="fa fa-fw fa-star"></i>
                    <span class="nav-link-text">ประกาศคิว</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookmarks">
                <a class="nav-link" href="<?php echo base_url('physician/time-manage');?>">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My profile">
                ...
                <ul class="sidenav-second-level collapse" id="collapseProfile">
                    <li>
                        <a href="user-profile.html">ข้อมูลคลีนิค</a>
                    </li>
                    <li>
                        <a href="doctor-profile.html">ข้อมูลแพทย์</a>
                    </li>
                </ul>
            </li>

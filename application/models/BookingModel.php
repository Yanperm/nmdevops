...
class BookingModel extends CI_Model
{
    ...
    public function getBookingByEmail($clicnicId, $email)
    {
        $query = $this->db->query('
            SELECT * FROM tbbooking as booking
            left join tbmembers as member on member.MEMBERIDCARD = booking.MEMBERIDCARD
    ...
    public function getBookingByEmailAndDate($clicnicId, $email, $date)
    {
        $query = $this->db->query('
            SELECT * FROM tbbooking as booking
            left join tbmembers as member on member.MEMBERIDCARD = booking.MEMBERIDCARD
            left join tbclinic as clinic on clinic.CLINICID = booking.CLINICID
            where  booking.BOOKDATE = "'.$date.'" AND member.EMAIL like "' . $email . '" AND booking.CLINICID = "' . $clicnicId . '"');
